...
function PatientApptAppBar({ mode, toggleColorMode }) {
          ...
          >
            ...
            >
              <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                ...
                <MenuItem component={Link} to="/ScheduleAppointment" sx={{ py: '6px', px: '12px' }}>
                  <Typography variant="body2" color="text.primary">
...
PatientApptAppBar.propTypes = {
  mode: PropTypes.oneOf(['dark', 'light']).isRequired,
  toggleColorMode: PropTypes.func.isRequired,
};

export default PatientApptAppBar;
